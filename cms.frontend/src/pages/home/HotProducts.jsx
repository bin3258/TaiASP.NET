    ...
    useEffect(() => {
        const fetch = async () => {
            try {
                ...
                console.error("Lỗi tải SP hot:", error);
            } finally {
                setLoading(false);
            }
        };
        ...
        <section className="product-grid">
            <div className="container">
                <div className="section-header">
                    <span className="section-header__subtitle">Top bán chạy</span>
                    <h2 className="section-header__title">Sản phẩm bán chạy nhất</h2>
                    <p className="section-header__desc">Được khách hàng yêu thích và lựa chọn nhiều nhất</p>
                </div>
